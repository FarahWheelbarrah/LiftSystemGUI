...
public class Building {
    ...
    private int top = 6;
    private IntegerProperty time = new SimpleIntegerProperty(0); // Time starts at zero
    ...
    public void call(Person caller, int destination) throws NoSuitableLiftException {
        if (levelOutOfRange(destination)) 
    ...
    private boolean levelOutOfRange(int destination) {
        return destination < getBottom() || destination > getTop();
    }
